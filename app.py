"""
NEWSLETTER API - ROOT LEVEL DEPLOYMENT FIX
This is a completely new structure to force deployment
"""
...
app = FastAPI(
    title="Newsletter API - ROOT LEVEL FIX",
    version="3.0.0-ROOT-FIX",
    description="Root level API to force deployment"
)
...
def startup_event():
    ...
    print("🚀 Starting Newsletter API - ROOT LEVEL FIX")
...
def root_endpoint():
    ...
    return {
        "status": "ok",
        "version": "3.0.0-ROOT-FIX",
        "message": "Newsletter API - ROOT LEVEL FIX",
        "docs": "/docs",
        "health": "/health",
        "deployment": "root-level-fix"
    }
